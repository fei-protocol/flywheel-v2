...
/**
 @title Multi-Delegation Voting contract
 @notice an extension which allows delegations to multiple delegatees up to `freeVotes` on a given block.
 */
abstract contract MultiVotes is Auth {
    ...
    /// @notice store seperate list of nonces for delegation
    ...
    function delegateBySig(
        ...
        require(block.timestamp <= expiry, "MultiVotes: signature expired");
        ...
        require(nonce == delegationNonces[signer]++, "MultiVotes: invalid nonce");
